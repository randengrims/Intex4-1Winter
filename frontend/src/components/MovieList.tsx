      ...
      try {
        ...
        if (Array.isArray(data.movies)) {
          ...
          for (const movie of data.movies) {
            ...
            if (
              seenTitles.current.has(movie.title) ||
              seenImages.current.has(imageUrl)
            )
              continue;
    ...
    <>
      ...
      {featuredMovie && (
        ...
        >
          ...
          />
          <div
            style={{ marginLeft: '20px', maxWidth: '60%', textAlign: 'left' }}
          >
            <h2>Featured Movie:</h2>
            <h3>
              {featuredMovie.title} ({featuredMovie.release_year})
            </h3>
            <p>
              <strong>Rating:</strong> {featuredMovie.rating}
            </p>
            <p>
              <strong>Description:</strong> {featuredMovie.description}
            </p>
            <button
              style={{
                marginTop: '10px',
          ...
          return (
            <div
              ...
              onMouseEnter={(e) => {
                ...
                ).querySelector('.overlay') as HTMLDivElement;
            ...
            <div style={{ position: 'relative', marginBottom: '1rem' }}>
              ...
              >
                ...
                <p style={{ fontSize: '0.9rem', opacity: 0.85 }}>
                  {selectedMovie.release_year} • {selectedMovie.rating} •{' '}
